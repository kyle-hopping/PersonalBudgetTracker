...
class SpendingsPage(BasePage):
    """Page for adding and listing spendings."""
    def __init__(self, parent, controller, spendings_list):
        super().__init__(parent, controller, "Spendings")
        ...
        tk.Button(input_frame, text="Add Spending", bg="#f44336", fg="white", font=BUTTON_FONT, command=self.add_spending).pack(pady=10, fill="x")
    ...
    def update_tree(self):
        """Refresh the treeview with current spendings."""
        self.tree.delete(*self.tree.get_children())
        for i, t in enumerate(self.spendings_list):
